      ...
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <FormControl
            ...
            alignItems="center"
            mb="4"
            isInvalid={!!formik.errors?.is_selected}
          >
            <FormLabel htmlFor="switch-is_selected">Is Selected</FormLabel>
            <Switch
              id="switch-is_selected"
              name="is_selected"
              onChange={formik.handleChange}
              value={formik.values?.is_selected ? 1 : 0}
            />
            {formik.errors?.is_selected && <FormErrorMessage>{formik.errors?.is_selected}</FormErrorMessage>}
          </FormControl>
