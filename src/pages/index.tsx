...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Dynamic forms AI`}</title>

        <meta
          name="description"
          content="Unleash your creativity with Dynamic Forms AI - Transforming feedback collection with dynamic, personalized forms that adapt to user responses."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1633613286991-611fe299c4be?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxmZWVkYmFja3xlbnwwfHx8fDE2OTcwMTYxNzN8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unleash your creativity with Dynamic Forms AI - Transforming feedback collection with dynamic, personalized forms that adapt to user responses.`}
            </Text>
            <Box
